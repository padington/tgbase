...
| `EatDeleteConfirmPhase` | `eat_delete_confirm` | `/food_delete` confirmation; confirm wipes all six eating fields + `EatConsentAt` in one `Set`. Cancel also consumes the mid-test marker it was opened with. |
