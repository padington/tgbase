...
## Content provenance (do not edit the texts)
...
- **WURS-25** — no validated Russian adaptation exists; unofficial
  ...
  The mandatory caveat lives in the content and is always rendered.
- **DSM-context module** — written from scratch for this bot (consent, intro,
  onset question, life domains, result templates). DSM-5 criterion texts are
  paraphrased, never quoted (APA copyright).
